          ...
          <Grid item sm={7}>
            <div className="homeBannerLeftArea">
                <div className="hmeBannerContentText">
                    ...
                    <h1 className={dmFont.className}>Find Next Place To <span style={{color:'#5C98F2'}}>Visit</span></h1>
